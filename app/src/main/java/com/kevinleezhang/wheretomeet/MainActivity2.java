package com.kevinleezhang.wheretomeet;
...
/* Setup the Google API object to allow Google+ logins */
    ...
    final Firebase ref = new Firebase("https://wheretomeet.firebaseio.com");
...
private void onFacebookSessionStateChange(Session session, SessionState state, Exception exception) {
    Firebase ref = new Firebase("https://wheretomeet.firebaseio.com");
    if (state.isOpened()) {
        ...
        AsyncTask<Void, Void, String> task = new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    ...
                    token = GoogleAuthUtil.getToken(MainActivity2.this, Plus.AccountApi.getAccountName(mGoogleApiClient), scope);
